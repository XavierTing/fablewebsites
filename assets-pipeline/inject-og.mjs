...
const SITE = 'https://fablex25.netlify.app';
...
for (const pg of pages) {
  ...
  const title = (html.match(/<title>([^<]+)<\/title>/) || [,'FABLE ×30'])[1].trim();
  const desc = (html.match(/<meta\s+name="description"\s+content="([^"]+)"/) || [,''])[1].trim()
    || 'Part of FABLE ×30 — twenty-five websites designed and built autonomously by Claude Fable 5.';
...
<meta property="og:site_name" content="FABLE ×30">
