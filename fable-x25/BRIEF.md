...
3. **Back-link to the gallery**: a small, elegant, fixed element (top-left or bottom-left) reading `XAVIER FABLE ×70` linking to `/` — style it to match the site's aesthetic, unobtrusive but findable.
