...
**Thirty-five fundamentally different websites — designed, written, art-directed and built end-to-end by Claude Fable 5, autonomously.**
...
├── index.html              # gallery homepage — a "living wall" of all 35 thumbnails
